...
![오픈AI CEO 샘 알트만(사진:ABC방송 캡처)](path/to/img.png)
...
---
<소감문>
마크다운과 주피터.. 아직 잘 모르겠다. 주피터에 관련된 기본 소양이 없으면 이 실습을 진행하기 어렵다. 예상된 학습수업 시간은 주피터에 대한 기본 소양을 알고 있을 때 전제가 되는 것 같은데 학습자의 상태에 따라서 이 실습을 진행함의 차이가 있을 것 같다.
=======
# first-repository
## git config
add new contents
...
>>> ~
>>> ~
>>>>>>> e2a9e2ffd8d132434b042cbc1e35349c61f94022
